...
class Curriculum2 extends StatefulWidget {
  const Curriculum2({Key? key}) : super(key: key);
  static const routeName = 'Curriculum2';

  @override
  _CurriculumState createState() => _CurriculumState();
}

class _CurriculumState extends State<Curriculum2> {
                                          ...
                                          children: [
                                            Column(
                                              children: [
                                                ...
                                                Icon(CourseList[index].hasPrize
                                                    ? Icons.check_box
                                                    : Icons
